# Claude coworker Prompt Command: Weekly Focus
...
Use this file as a paste/reference prompt for Claude coworker. Slash commands such as `/weekly-focus` are Claude Code interactive only.
