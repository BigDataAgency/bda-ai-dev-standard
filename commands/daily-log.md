...
Daily work summary command with evidence guardrails. This is the canonical `daily-log` command and uses `templates/daily-log.md`.

## ใช้เมื่อ

ต้องการสรุปงานรายวันแบบตรวจสอบได้ โดยใช้ชื่อปกติ `daily-log`.

## Files

- Command: `commands/daily-log.md`
- Template: `templates/daily-log.md`
- Claude Code slash command: `/daily-log` จาก `claude/commands/daily-log.md`
...
โปรดทำตามขั้นตอนนี้:
1. อ่านและใช้ standard `commands/daily-log.md` กับ `templates/daily-log.md`
...
Output ที่ต้องส่ง: Daily Log ตาม template
...
- [ ] ใช้ `commands/daily-log.md` และ `templates/daily-log.md`
...
1. **BDA Standard files used** — ระบุ path ของไฟล์มาตรฐาน BDA ที่เปิด/อ้างอิงจริง เช่น `commands/daily-log.md`, `templates/daily-log.md`
...
---
ใช้ `daily-log` เป็น canonical command สำหรับ daily work summary พร้อม evidence.
